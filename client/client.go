...
func (c *Client) Post(endpoint string, parameters url.Values, body string) (*http.Response, error) {
	return c.sender.Send(request.Request{
		Method:   "POST",
		Endpoint: endpoint,
		Values:   parameters,
...
func (c *Client) Put(endpoint string, parameters url.Values, body string) (*http.Response, error) {
	return c.sender.Send(request.Request{
		Method:   "PUT",
		Endpoint: endpoint,
		Values:   parameters,
